...
export const metadata: Metadata = {
  title: "Mock Tests — Timed Practice for JEE, NEET & CUET",
  description:
    "Full-length, timed mock tests with real exam patterns and negative marking for JEE Main, JEE Advanced, NEET and CUET.",
};
